...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "rates_iAHP", _hoc_rates,
 "states_iAHP", _hoc_states,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 iAHP /Users/mehow/src-uni/neuron/MyFirstNEURON/iahp.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "slow Ca-dependent potassium current (AHP-current)";
...
static int _ode_count(int _type){ hoc_execerror("iAHP", "cannot be used with CVODE"); return 0;}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mehow/src-uni/neuron/MyFirstNEURON/iahp.mod";
static const char* nmodl_file_text = 
