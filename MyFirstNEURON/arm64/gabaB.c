...
#define nrn_init _nrn_init__GABAbSynapse
#define _nrn_initial _nrn_initial__GABAbSynapse
#define nrn_cur _nrn_cur__GABAbSynapse
#define _nrn_current _nrn_current__GABAbSynapse
#define nrn_jacob _nrn_jacob__GABAbSynapse
#define nrn_state _nrn_state__GABAbSynapse
#define _net_receive _net_receive__GABAbSynapse 
...
#define kf kf_GABAbSynapse
 ...
 "kf_GABAbSynapse", &kf_GABAbSynapse,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 GABAbSynapse /Users/mehow/src-uni/neuron/MyFirstNEURON/gabaB.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
 ...
 _ltt = ( t - onset ) * tadj ;
   if ( t > onset ) {
     g = w * gmaxIPSP * ( 0.84 * exp ( - _ltt / 283.0 ) + 0.16 * exp ( - _ltt / 1026.0 ) ) * ( pow( ( 1.0 - exp ( - _ltt / 112.0 ) ) , 4.0 ) ) / 0.31 ;
     }
   else {
     g = 0.0 ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mehow/src-uni/neuron/MyFirstNEURON/gabaB.mod";
static const char* nmodl_file_text = 
  "TITLE GABAb synapse\n"
  "\n"
  "COMMENT\n"
