...
#define nrn_init _nrn_init__GABAaSynapse
#define _nrn_initial _nrn_initial__GABAaSynapse
#define nrn_cur _nrn_cur__GABAaSynapse
#define _nrn_current _nrn_current__GABAaSynapse
#define nrn_jacob _nrn_jacob__GABAaSynapse
#define nrn_state _nrn_state__GABAaSynapse
#define _net_receive _net_receive__GABAaSynapse 
...
#define gmaxIPSP _p[1]
#define gmaxIPSP_columnindex 1
#define w _p[2]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cl_ion");
 	...
 	ivoc_help("help ?1 GABAaSynapse /Users/mehow/src-uni/neuron/MyFirstNEURON/gabaA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "GABAa synapse";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   double _ltt ;
 _ltt = ( t - onset ) * tadj ;
   if ( ( t > onset )  && ( _ltt < 740.0 ) ) {
     g = w * gmaxIPSP * exp ( - _ltt / 25.0 ) * ( 1.0 - exp ( - _ltt / 1.0 ) ) / 0.84 ;
     }
   else {
     g = 0.0 ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mehow/src-uni/neuron/MyFirstNEURON/gabaA.mod";
static const char* nmodl_file_text = 
  "TITLE GABAa synapse\n"
  "\n"
  "COMMENT\n"
