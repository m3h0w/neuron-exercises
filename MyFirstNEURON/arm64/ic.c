...
#define nrn_init _nrn_init__iC
#define _nrn_initial _nrn_initial__iC
#define nrn_cur _nrn_cur__iC
#define _nrn_current _nrn_current__iC
#define nrn_jacob _nrn_jacob__iC
#define nrn_state _nrn_state__iC
#define _net_receive _net_receive__iC 
#define rates rates__iC 
#define states states__iC 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_iC", _hoc_setdata,
 "rates_iC", _hoc_rates,
 "states_iC", _hoc_states,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "ca_ion");
 	...
 	ivoc_help("help ?1 iC /Users/mehow/src-uni/neuron/MyFirstNEURON/ic.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Ca-dependent potassium current (C-current)";
...
static int  rates ( _threadargsprotocomma_ double _lv , double _lcai ) {
   double _la , _lb ;
 _la = 250.0 * _lcai * exp ( _lv / 24.0 ) ;
   _lb = 0.1 * exp ( - _lv / 24.0 ) ;
...
static int _ode_count(int _type){ hoc_execerror("iC", "cannot be used with CVODE"); return 0;}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/mehow/src-uni/neuron/MyFirstNEURON/ic.mod";
static const char* nmodl_file_text = 
